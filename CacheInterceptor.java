...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header(DefaultHttpClient.CONTENT_TYPE_KEY), response.body().contentLength(), Okio.buffer((Source) r2))).build();
    }
    ...
    static boolean isContentSpecificHeader(String str) {
        return "Content-Length".equalsIgnoreCase(str) || "Content-Encoding".equalsIgnoreCase(str) || DefaultHttpClient.CONTENT_TYPE_KEY.equalsIgnoreCase(str);
    }
}
